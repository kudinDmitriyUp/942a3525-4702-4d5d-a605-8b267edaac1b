...
export const metadata: Metadata = {
  title: "Luxora Premium Mattress | Luxury Sleep Experience",
  description: "Experience the ultimate in luxury sleep with Luxora's hand-crafted premium mattresses. Expert craftsmanship, natural materials, lifetime warranty.",
  keywords: "luxury mattress, premium sleep, handcrafted mattress, organic mattress, high-end bed",
  metadataBase: new URL("https://luxora.com"),
  alternates: {
    canonical: "https://luxora.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Luxora Premium Mattress | Crafted for Extraordinary Sleep",
    description: "Discover the finest luxury mattresses. Hand-stitched perfection with natural materials and lifetime support.",
    type: "website",
    siteName: "Luxora",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764876183086-k0ra9n5w.jpg",
        alt: "Luxora Premium Mattress"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxora Premium Mattress",
    description: "Experience luxury sleep like never before with Luxora's hand-crafted premium mattresses.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764876183086-k0ra9n5w.jpg"]
  }
};
